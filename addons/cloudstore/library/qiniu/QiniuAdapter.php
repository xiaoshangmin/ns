...
namespace addons\cloudstore\library\qiniu;
 ...
 *
 */
class QiniuAdapter extends AbstractAdapter implements AdapterInterface
{
    ...
    public function getUrl($path)
    {
        ...
        return $this->normalizeHost($this->domain).ltrim(implode('/',
                array_map('rawurlencode', explode('/', $segments['path']))), '/').$query;
    }
