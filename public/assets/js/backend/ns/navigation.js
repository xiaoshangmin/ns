define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'ns.navigation/index' + location.search,
                    add_url: 'ns.navigation/add',
                    edit_url: 'ns.navigation/edit',
                    del_url: 'ns.navigation/del',
                    multi_url: 'ns.navigation/multi',
                    table: 'navigation',
                }
            });
